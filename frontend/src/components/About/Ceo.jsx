...
function Ceo() {
  ...
  <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
    <div className="grid items-center grid-cols-1 md:grid-cols-2">
      <div>
        <h2 className="text-3xl font-bold leading-tight text-gray-600 sm:text-4xl lg:text-5xl">Hey 👋 I'm
          <br className="block sm:hidden" /> <span className='font-bold text-6xl text-blue-600'>Pankaj kumar</span> <br className="block sm:hidden" /> <span className=' text-2xl text-gray-800'>CEO of mars computer</span>
        </h2>
